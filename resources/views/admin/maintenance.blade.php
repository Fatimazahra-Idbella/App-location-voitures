...
@if (Auth::user()->isAdmin)
    @section('repair_table')
        <table class="table align-items-center justify-content-center mb-0">
            <thead>
                <tr>
                    ...
                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2 text-center">videnge
                    </th>
                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2 text-center">plaquette
                    </th>
                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2 text-center">croix
                        chaine</th>
            ...
            <tbody>
                @foreach ($cars as $car)
                    <tr>
                            ...
                            <div class="d-flex px-2">
                                <div>
                                    <img src="../assets/img/small-logos/{{ $car->marque}}.svg"
                                        class="avatar avatar-sm rounded-circle me-2" alt="{{ $car->marque}}">
                                </div>
                                <div class="my-auto">
                                    <h6 class="mb-0 text-sm">{{ $car->marque}} {{ $car->model}}</h6>
                                    <p class="text-xs text-secondary font-weight-bold mb-0">{{ $car->matriculG}}
                                        /&nbsp<bdi>{{ $car->matriculL}}</bdi>&nbsp/ {{ $car->matriculS}}</p>
                                </div>
                            </div>
                        </td>
                                ...
                                <div>
                                    <div class="progress mx-auto">
                                        <div class="progress-bar" role="progressbar" aria-valuenow="60" aria-valuemin="0"
                                            aria-valuemax="100" style="width: {{$percevidenge}}%;
                                        background-color:
                                            @if($percevidenge > 50)
                                                rgb(0, {{ (255 * ($percevidenge - 50)) / 50 }}, 0)
                                            @elseif($percevidenge < 50)
                                ...
                                <div>
                                    ...
                                    <div class="progress mx-auto">
                                        <div class="progress-bar bg-gradient-info" role="progressbar" aria-valuenow="60"
                                            aria-valuemin="0" aria-valuemax="100" style="width: {{$perceplaquette}}%;"></div>
                                    </div>
                                </div>
                                <div>
                        ...
                        <td class="align-middle text-center">
                            <div class="flex-column align-items-center justify-content-center">
                                ...
                                <div>
                                    <div class="progress mx-auto">
                                        <div class="progress-bar" role="progressbar" aria-valuenow="60" aria-valuemin="0"
                                            aria-valuemax="100" style="width: {{$perceCroit}}%;
                                        background-color:
                                            @if($perceCroit > 50)
                                                rgb(0, {{ (255 * ($perceCroit - 50)) / 50 }}, 0)
                                            @elseif($perceCroit < 50)
                        ...
                        <td class="align-middle text-center">
                            <a href="javascript:void(0)" onclick="addrepair({{ $car->id }})"
                                class="text-success font-weight-bold text-xs" data-toggle="modal" data-target="#addrepairModal">
                                Add
                            </a>
                            <br>
                            <a href="javascript:void(0)" onclick="editrepair({{ $car->id }})"
                                class="text-warning font-weight-bold text-xs" data-toggle="modal" data-target="#editrepairModal">
                                Update
                            </a>
                        </td>
                        <td class="align-middle text-center">
                            <a href="javascript:void(0)" onclick="printrepair({{ $car->id }})"
                                class="text-info font-weight-bold text-xs" data-toggle="modal" data-target="#printrepairModal">
                                Print
                            </a>
                            <br>
                            <a href="javascript:void(0)" onclick="deletrepairmodal({{ $car->id }})"
                                class="text-danger font-weight-bold text-xs" data-toggle="modal" data-target="#deletrepairModal">
                                Delete
                            </a>
                        </td>
                    </tr>
        ...
        <div class="modal fade" id="AddrepairModal" tabindex="-1" role="dialog" aria-labelledby="AddrepairModalLabel"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
                        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                            <div class="navbar-nav d-flex justify-content-around w-100">
                                <label id="navCompteur" for="radioCompteur" role="button" onclick="chk_type_repair()"
                                    style="background-color: #7b809a;"><span class="nav-item nav-link">Compteur<span
                                            class="sr-only">(current)</span></span></label>
                                <label id="navVidenge" for="radioVidenge" role="button" onclick="chk_type_repair()"><span
                                        class="nav-item nav-link">Videnge</span></label>
                                <label id="navPlaquette" for="radioPlaquette" role="button" onclick="chk_type_repair()"><span
                                        class="nav-item nav-link">Plaquette</span></label>
                                <label id="navAutre" for="radioAutre" role="button" onclick="chk_type_repair()"><span
                                        class="nav-item nav-link">Autre repair</span></label>
                            </div>
                        </div>
                    ...
                    <div id="type_Vehicule" class="card-body pb-0">
                        ...
                        <table>
                            <tr>
                                ...
                                <td>
                                    <div class="input-group input-group-outline my-3">
                                        <input id="addrepaircar" name="addrepaircar" type="text" value="{{ old('marquecar') }}"
                                            class="form-control text-center @error('addrepaircar') is-invalid @enderror"
                                            required autocomplete="addrepaircar" disabled>
                                        @error('addrepaircar')
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="input-group input-group-outline my-3">
                                        <input placeholder="{{ __('Matricule') }}" id="addmatriculeG" name="addmatriculeG"
                                            type="text" class="form-control @error('addmatriculeG') is-invalid @enderror"
                                            required autocomplete="addmatriculeG" disabled>
                                        @error('addmatriculeG')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                        @enderror
                                        <select class="form-control text-center mx-3" name="addMatriculeL" id="addMatriculeL"
                                            value="{{ old('addMatriculeL') }}" required disabled>
                                            <option>..</option>
                                        ...
                                        <input placeholder="{{ __('Matricule') }}" id="addmatriculeS" name="addmatriculeS"
                                            type="text" class="form-control @error('addmatriculeS') is-invalid @enderror"
                                            required autocomplete="addmatriculeS" disabled>
                                        @error('addmatriculeS')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                    ...
                    <div id="type_Compteur">
                        <form id="formUpdateCont" method="POST" action="" role="form" class="text-start">
                                ...
                                <div class="card-body">
                                    ...
                                    <table class="w-100">
                                        <tr>
                                            ...
                                            <td>
                                                <div class="input-group input-group-outline my-3">
                                                    <input placeholder="{{ __('Compteur Km') }}" id="CompteurcarOld" name=""
                                                        type="number" class="form-control mr-2" disabled>
                                                    <input id="dt_ContrepairOld" name="" type="date" class="form-control ml-2"
                                                        disabled>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="input-group input-group-outline my-3">
                                                    <input placeholder="{{ __('Compteur Km') }}" id="EditCompteurcar"
                                                        name="Compteurcar" type="number"
                                                        class="form-control mr-2 @error('Compteurcar') is-invalid @enderror"
                                                        value="{{ old('Compteurcar') }}" required autocomplete="Compteurcar"
                                                        autofocus>
                                                    @error('Compteurcar')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                    ...
                                                    @enderror
                                                    <input id="dt_Contrepair" name="d_Compteurcar" type="date"
                                                        class="form-control ml-2 @error('dt_Contrepair') is-invalid @enderror">
                                                    @error('dt_Contrepair')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                            ...
                            <div class="modal-footer">
                                <button onclick="modalclosebtn()" type="button" class="btn btn-dark"
                    ...
                    <div id="type_Videnge">
                        <form method="POST" action="{{ Route('admin.addvidenge') }}" role="form" class="text-start"
                            onsubmit="submitvidenge()">
                            <div class="modal-body">
                                <div class="card-body">
                                    @csrf
                                    ...
                                    <table class="w-100">
                                        <tr>
                                            ...
                                            <td colspan="2">
                                                <div class="input-group input-group-outline my-3">
                                                    <input placeholder="{{ __('Videnge') }}" id="videngerepair"
                                                        name="videngerepair" type="number"
                                                        class="form-control @error('videngerepair') is-invalid @enderror"
                                                        required autofocus>
                                                    @error('videngerepair')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2">
                                                <div class="input-group input-group-outline my-3">
                                                    <input id="dt_videngerepair" name="dt_videngerepair" type="date"
                                                        class="form-control @error('dt_videngerepair') is-invalid @enderror">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="input-group input-group-outline my-3">
                                                    ...
                                                    <input type="checkbox" name="chk_Filterair" id="chk_Filterair" value="1"
                                                        class="mx-3">
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                                <div class="input-group input-group-outline my-3">
                                                    ...
                                                    <input type="checkbox" name="chk_Filteroil" id="chk_Filteroil" value="1"
                                                        class="mx-3">
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="input-group input-group-outline my-3">
                                                    ...
                                                    <input type="checkbox" name="chk_Filtergasoil" id="chk_Filtergasoil"
                                                        value="1" class="mx-3">
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                                <div class="input-group input-group-outline my-3">
                                                    ...
                                                    <input type="checkbox" name="chk_plaquette" id="chk_plaquette" value="1"
                                                        class="mx-3">
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="input-group input-group-outline my-3">
                                                    ...
                                                    <input type="checkbox" name="chk_croix_chaine" id="chk_croix_chaine"
                                                        value="1" class="mx-3">
                                                </div>
                                            </td>
                                            <td>
                    ...
                    <div id="type_Plaquette">
                        <form method="POST" action="{{ Route('admin.addplaquette') }}" role="form" class="text-start"
                            id="FormAddplaquette">
                            <div class="modal-body">
                                <div class="card-body">
                                    @csrf
                                    <table class="w-100">
                                        <tr>
                                            ...
                                            <td colspan="2">
                                                <div class="input-group input-group-outline my-3">
                                                    <input placeholder="{{ __('Plaquette') }}" id="Plaquetterepair"
                                                        name="Plaquetterepair" type="number"
                                                        class="form-control @error('Plaquetterepair') is-invalid @enderror"
                                                        required autocomplete="Plaquetterepair" autofocus>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2">
                                                <div class="input-group input-group-outline my-3">
                                                    <input id="dt_Plaquetterepair" name="dt_Plaquetterepair" type="date"
                                                        class="form-control @error('dt_Plaquetterepair') is-invalid @enderror">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="input-group input-group-outline my-3">
                                                    ...
                                                    <input type="checkbox" name="chk_PlaquetteAV" id="chk_PlaquetteAV" value="1"
                                                        class="mx-3" checked>
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                                <div class="input-group input-group-outline my-3">
                                                    ...
                                                    <input type="checkbox" name="chk_PlaquetteAR" id="chk_PlaquetteAR" value="1"
                                                        class="mx-3">
                                                </div>
                                            </td>
                                        </tr>
                            ...
                            <div class="modal-footer">
                                <button onclick="modalclosebtn()" type="button" class="btn btn-dark"
                                    data-dismiss="modal">Close</button>
                                {{-- <button onclick="submitplaquette2()" type="button" class="btn btn-info">Save
                                    changes</button> --}}
                                <input type="submit" class="btn btn-info" value="Save changes">
                            </div>
                        </form>
                    ...
                    <div id="type_Autre">
                        <form method="POST" action="{{ Route('admin.addOderRepair') }}" id="FormAddOderRepair" role="form"
                            class="text-start">
                            <div class="modal-body">
                                <div class="card-body">
                                    @csrf
                                    ...
                                    <table class="w-100">
                                        <tr>
                                            ...
                                            <td>
                                                <div class="input-group input-group-outline my-3">
                                                    <textarea id="TextRepair" name="TextRepair"
                                                        class="form-control @error('TextRepair') is-invalid @enderror" cols="40"
                                                        rows="5"></textarea>
                                                    @error('TextRepair')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="input-group input-group-outline my-3">
                                                    <input id="dt_Repair" name="dt_Repair" type="date"
                                                        class="form-control @error('dt_Repair') is-invalid @enderror">
                                                    @error('dt_Repair')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
                        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                            <div class="navbar-nav d-flex justify-content-around w-100">
                                <label id="navinterv2" for="radioInterv2" role="button" onclick="chk_type_repair_update()"
                                    style="background-color: #7b809a;"><span class="nav-item nav-link">Intervalle<span
                                            class="sr-only">(current)</span></span></label>
                                <label id="navVidenge2" for="radioVidenge2" role="button"
                                    onclick="chk_type_repair_update()"><span class="nav-item nav-link">Videnge</span></label>
                                <label id="navPlaquette2" for="radioPlaquette2" role="button"
                                    onclick="chk_type_repair_update()"><span class="nav-item nav-link">Plaquette</span></label>
                                <label id="navAutre2" for="radioAutre2" role="button" onclick="chk_type_repair_update()"><span
                                        class="nav-item nav-link">Autre repair</span></label>
                            </div>
                        </div>
                        <input type="radio" name="radiorepairnav2" id="radioInterv2" onchange="chk_type_repair_update()" hidden>
                        <input type="radio" name="radiorepairnav2" id="radioVidenge2" onchange="chk_type_repair_update()"
                            hidden>
                        <input type="radio" name="radiorepairnav2" id="radioPlaquette2" onchange="chk_type_repair_update()"
                            hidden>
                    ...
                    <div id="type_Vehicule" class="card-body pb-0">
                        ...
                        <table>
                            <tr>
                                ...
                                <td>
                                    <div class="input-group input-group-outline my-3">
                                        <input id="Editmrepaircar" name="Editmrepaircar" type="text"
                                            value="{{ old('marquecar') }}" class="form-control text-center" required
                                            autocomplete="addrepaircar" disabled>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <div class="input-group input-group-outline my-3">
                                        <input placeholder="{{ __('Matricule') }}" id="EditmatriculeG" name="EditmatriculeG"
                                            type="text" class="form-control" required autocomplete="addmatriculeG" disabled>
                                        <select class="form-control text-center mx-3" name="EditMatriculeL" id="EditMatriculeL"
                                            value="{{ old('addMatriculeL') }}" required disabled>
                                            <option>..</option>
                                            <option value="أ">أ</option>
                                            <option value="ب">ب</option>
                                        ...
                                        <input placeholder="{{ __('Matricule') }}" id="EditmatriculeS" name="EditmatriculeS"
                                            type="text" class="form-control" required autocomplete="addmatriculeS" disabled>
                                    </div>
                                </td>
                            </tr>
                        </table>
                                ...
                                <div class="card-body">
                                    ...
                                    <table class="w-100">
                                        <tr>
                                            ...
                                            <td>
                                                <div class="input-group input-group-outline my-3">
                                                    <input placeholder="{{ __('Videnge Intervalle') }}" id="InterVidengeOld"
                                                        name="InterVidenge" type="number" step="100" class="form-control mr-2">
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="input-group input-group-outline my-3">
                                                    <select name="InterPlaquette" id="InterPlaquetteOld"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="input-group input-group-outline my-3">
                                                    <input placeholder="{{ __('Croix Intervalle') }}" id="InterCroixOld"
                                                        name="InterCroix" type="number" step="1000" class="form-control mr-2">
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
                    ...
                    <div id="type_Videnge_update">
                        <form method="POST" id="formUpdateVidenge" action="" role="form" class="text-start"
                            onsubmit="submitvidenge()">
                            <div class="modal-body">
                                <div class="card-body">
                                    @csrf
                                    ...
                                    <table class="w-100">
                                        <tr>
                                            ...
                                            <td>
                                                <div class="input-group input-group-outline my-3">
                                                    <input placeholder="{{ __('Videnge') }}" id="videngerepairUpdate"
                                                        name="videngerepairUpdate" type="number" class="form-control" required
                                                        autofocus>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="input-group input-group-outline my-3">
                                                    <input id="dt_videngerepairUpdate" name="dt_videngerepairUpdate" type="date"
                                                        class="form-control">
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="input-group input-group-outline my-3">
                                                    ...
                                                    <input type="checkbox" name="chk_FilterairUP" id="chk_FilterairUP" value="1"
                                                        class="mx-3">
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                                <div class="input-group input-group-outline my-3">
                                                    ...
                                                    <input type="checkbox" name="chk_FilteroilUP" id="chk_FilteroilUP" value="1"
                                                        class="mx-3">
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="input-group input-group-outline my-3">
                                                    ...
                                                    <input type="checkbox" name="chk_FiltergasoilUP" id="chk_FiltergasoilUP"
                                                        value="1" class="mx-3">
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                                <div class="input-group input-group-outline my-3">
                                                    ...
                                                    <input type="checkbox" name="chk_plaquetteUP" id="chk_plaquetteUP" value="1"
                                                        class="mx-3">
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="input-group input-group-outline my-3">
                                                    ...
                                                    <input type="checkbox" name="chk_croix_chaineUP" id="chk_croix_chaineUP"
                                                        value="1" class="mx-3">
                                                </div>
                                            </td>
                                            <td colspan="2">
                                                <div class="input-group input-group-outline my-3">
                                                    <input type="number" step="1000" name="inter_videnge" id="inter_videnge"
                                ...
                                <div class="card-body">
                                    ...
                                    <table class="w-100">
                                        <tr>
                                            ...
                                            <td colspan="2">
                                                <div class="input-group input-group-outline my-3">
                                                    <input placeholder="{{ __('Plaquette') }}" id="PlaquetterepairUP"
                                                        name="PlaquetterepairUP" type="number" class="form-control" required
                                                        autocomplete="PlaquetterepairUP" autofocus>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td colspan="2">
                                                <div class="input-group input-group-outline my-3">
                                                    <input id="dt_PlaquetterepairUP" name="dt_PlaquetterepairUP" type="date"
                                                        class="form-control">
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="input-group input-group-outline my-3">
                                                    ...
                                                    <input type="checkbox" name="chk_PlaquetteAV_UP" id="chk_PlaquetteAV_UP"
                                                        value="1" class="mx-3">
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                                <div class="input-group input-group-outline my-3">
                                                    ...
                                                    <input type="checkbox" name="chk_PlaquetteAR_UP" id="chk_PlaquetteAR_UP"
                                                        value="1" class="mx-3">
                                                </div>
                                            </td>
                                        </tr>
                                ...
                                <div class="card-body">
                                    ...
                                    <table class="w-100">
                                        <tr>
                                            ...
                                            <td>
                                                <div class="input-group input-group-outline my-3">
                                                    <textarea id="TextRepair_UP" name="TextRepair_UP"
                                                        class="form-control @error('TextRepair_UP') is-invalid @enderror"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="input-group input-group-outline my-3">
                                                    <input id="dt_Repair_UP" name="dt_Repair_UP" type="date"
                                                        class="form-control @error('dt_Repair_UP') is-invalid @enderror">
                                                    @error('dt_Repair_UP')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
        ...
        {{-- Delete Modal --}}
        <div class="modal fade" id="deletrepairModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
